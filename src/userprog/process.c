...
#if 1
      if(!add_sup_page_table_entry (file, of, upage, page_read_bytes, page_zero_bytes, writable))
    	  return false;



#else
      if(!add_sup_page_table_entry (file, ofs, upage, page_read_bytes, page_zero_bytes, writable))
          	  return false;
